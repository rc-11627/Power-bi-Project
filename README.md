🌆 City Pulse: Smart Urban Mobility & Safety Dashboard
...
Delhi reports the highest accident average (414), aligned with high AQI and traffic density.

Mumbai peaks in accidents during monsoon months (June–September).

Bengaluru shows high sentiment but suffers from increasing accident trends.

Jaipur remains the safest city with the lowest accidents and AQI levels and with highest sentiment as well.

High traffic density zones show 40–50% higher accident frequency.

AQI worsens in winter for Delhi, Mumbai, Bengaluru, impacting commute time.

Rainfall has a direct correlation with increased accident risk in coastal cities.

Avg commute time increases by 15+ minutes during peak AQI periods.

Festivals & political events lead to noticeable spikes in traffic & accidents.
